...
// google("その少女の生い立ちは不幸そのものだった。殻に閉じこもる性格のせいで友だちなどいない。性格を治すために母に入れられた施設では、大人たちに虐待される日々。嫌なこと、痛いこと……。痛いこと、痛いこと、痛いこと、痛いこと。そして歪む運命。それが南沢泉理という少女だった。", function(err, data){
//     if(err) throw err;
//     console.log(data)
// })